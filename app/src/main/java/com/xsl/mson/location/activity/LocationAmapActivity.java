package com.xsl.mson.location.activity;
...
import com.xsl.mson.location.helper.NimGeocoder;
import com.xsl.mson.location.helper.NimLocationManager;
import com.xsl.mson.location.model.NimLocation;

public class LocationAmapActivity extends Activity implements OnCameraChangeListener, OnClickListener
...
//        setToolBar(R.id.toolbar, options);
    ...
    private void initView() {
        sendButton = (TextView) findViewById(R.id.action_bar_right_clickable_textview);
