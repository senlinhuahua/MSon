package com.xsl.mson.chat.viewhodler;
...
import com.xsl.mson.chat.listpanel.BaseMultiItemFetchLoadAdapter;
import com.xsl.mson.chat.listpanel.MsgViewHolderBase;
import com.xsl.mson.utils.ScreenUtil;
import com.xsl.mson.utils.TimeUtil;
...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    private void layoutByDirection() {
        if (isReceivedMessage()) {
            ...
            animationView.setBackgroundResource(R.drawable.ic_timeline_32dp);
    ...
    private MessageAudioControl.AudioControlListener onPlayListener = new MessageAudioControl.AudioControlListener() {
        ...
        @Override
        public void updatePlayingProgress(BaseAudioControl.Playable playable, long curPosition) {
        ...
        @Override
        public void onAudioControllerReady(BaseAudioControl.Playable playable) {
            if (!isTheSame(message.getUuid())) {
                return;
            }
        ...
        @Override
        public void onEndPlay(BaseAudioControl.Playable playable) {
            if (!isTheSame(message.getUuid())) {
                return;
            }
